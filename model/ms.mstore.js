define(function(require, exports, module) {
	...
	return {
		...
		people: {
			 ...
			 */
			list: function(func) {
				ajaxCfg.url = mstore + "/people/upgrader/version/list.do";
				ms.ajax(ajaxCfg, func)
			},
			save: function(data, func) {
				ajaxCfg.url = mstore + "/people/upgrader/version/save.do";
				ajaxCfg.params = data;
				ms.ajax(ajaxCfg, func)
			},
			delete: function(id, func) {
				ajaxCfg.url = mstore + "/people/upgrader/version/delete.do";
				ms.ajax(ajaxCfg, func)
			},
			release: function(id, data, func) {
				...
				ajaxCfg.url = mstore + "/people/upgrader/version/" + id + "/release.do";
				ajaxCfg.params = data;
				ms.ajax(ajaxCfg, func)
			},
			edit: function(id, func) {
				...
				ajaxCfg.url = mstore + "/people/upgrader/version/" + id + "/edit.do";
				ms.ajax(ajaxCfg, func)
			},
			/**
             *用户详情
             ...
             */
			data: function(func) {
				ajaxCfg.url = mstore + "/people/mstore/data.do";
				ms.ajax(ajaxCfg, func);
			},
			payList: function(func) {
				ajaxCfg.url = mstore + "/people/mstore/payList.do";
				ms.ajax(ajaxCfg, func);
			},
			downList: function(func) {
				ajaxCfg.url = mstore + "/people/mstore/downList.do";
				ms.ajax(ajaxCfg, func);
			},
			userList: function(func) {
				ajaxCfg.url = mstore + "/people/mstore/userList.do";
				ms.ajax(ajaxCfg, func);
			},
			/**
		    * 获取相应的插件信息
		   ...
		   */
			detail: function(data, func) {
				...
				ajaxCfg.url = ms.base + "/people/mstore/detail.do";
				ajaxCfg.params = data;
				ms.ajax(ajaxCfg, func);
			},
			/**
		   ...
		   */
			pay: function(id, func) {
				...
				ajaxCfg.url = ms.base + "/people/mstore/" + id + "/pay.do";
				ms.ajax(ajaxCfg, func);
			},
			/**
		    * 下载资源
		   ...
		   */
			down: function(data, func) {
				...
				ajaxCfg.url = ms.base + "/people/mstore/down.do";
				ajaxCfg.params = data;
				ms.ajax(ajaxCfg, func);
			},
		},
