	...
	return {
		...
		people: {
		   ...
		   */
			detail: function(data, func) {
				...
				ajaxCfg.url = mstoreHost + "/people/mstore/detail.do";
				ajaxCfg.params = data;
				ms.ajax(ajaxCfg, func);
			},
			/**
		   ...
		   */
			pay: function(id, func) {
				...
				ajaxCfg.url = mstoreHost + "/people/mstore/" + id + "/pay.do";
				ms.ajax(ajaxCfg, func);
			},
			/**
		    * 下载资源
		   ...
		   */
			down: function(data, func) {
				...
				ajaxCfg.url = mstoreHost + "/people/upgrader/upgraderPeopleVersion/down.do";
				ajaxCfg.params = data;
				ms.ajax(ajaxCfg, func);
			},
		},
		mstore: {
			...
			topSponsor: function(func) {
				ajaxCfg.url = mstoreHost + "/mstore/topSponsor.do";
				ms.ajax(ajaxCfg, func);
			},
			/**
			*分享者列表
			...
			*/
			topShareUser: function(func) {
				ajaxCfg.url = mstoreHost + "/mstore/topShareUser.do";
				ms.ajax(ajaxCfg, func);
			},
			topDown: function(func) {
				ajaxCfg.url = mstoreHost + "/mstore/topDown.do";
				ms.ajax(ajaxCfg, func);
			},
			/**
			  * 模板列表
			...
			list: function(data, func) {
				...
				ajaxCfg.url = mstoreHost + "/mstore/list.do";
				ajaxCfg.params = data;
				ms.ajax(ajaxCfg, func);
			},
			/**
			...
			*/
			count: function(func) {
				ajaxCfg.url = mstoreHost + "/mstore/count.do";
				ms.ajax(ajaxCfg, func);
			},
			/**
		    * 获取论坛图片
		   ...
		   */
			img: function(data, func) {
				...
				ajaxCfg.url = mstoreHost + "/mstore/img.do";
				ajaxCfg.params = data;
				ms.ajax(ajaxCfg, func);
			},
		},
