			...
			mcode : {
				project : {
					...
					save : function(data,func){
				    	...
				    	if(validator.isNull(newDataJson.projectUpgraderVersionId)){
				    		ms.alert("版本关联编号不能为空");
							return;
				    	}else if(!validator.isInt(newDataJson.projectUpgraderVersionId)){
							ms.alert("版本关联编号为整型");
							return;
						};
					...
					/*获取项目*/
					get : function(projectUpgraderVersionId,func){
						if(!validator.isNull(projectUpgraderVersionId)){
							if(!validator.isInt(projectUpgraderVersionId)){
								ms.alert("版本编号为整型");
								return;
							}
						}else{
				    	...
				    	ajaxCfg.params = "projectUpgraderVersionId="+projectUpgraderVersionId;
